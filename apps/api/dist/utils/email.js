...
exports.sendMonthlyReportEmail = exports.sendResetSuccessEmail = exports.sendResetPasswordEmail = exports.sendWelcomeEmail = exports.sendEmail = exports.getEmailConfig = void 0;
...
const sendEmail = async (to, subject, html) => {
    try {
        const config = await (0, exports.getEmailConfig)();
...
const sendResetSuccessEmail = async (to, firstName) => {
    const config = await (0, exports.getEmailConfig)();
...
const sendMonthlyReportEmail = async (to, data) => {
    const config = await (0, exports.getEmailConfig)();
